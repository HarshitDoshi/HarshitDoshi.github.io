    ...
    <header className="w-full fixed top-0 z-50 text-gray-900 dark:text-gray-50 body-font shadow-lg border-b-2 border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 dark:shadow-none">
      <div className="flex flex-wrap my-2 flex-col  md:flex-row items-start md:items-center justify-between">
        <div className="flex flex-wrap flex-col md:flex-row items-center md:items-center justify-between w-full">
          ...
          <nav className={"md:mx-4 my-2 md:my-0 grid grid-cols-2 gap-y-1 gap-x-1 md:flex md:flex-row items-start md:items-center text-base justify-start md:justify-center w-2/3" + (navigationMenuState ? "md:flex" : " hidden")}>
        ...
        <div className={"w-full flex flex-row justify-center items-center mt-2" + (navigationMenuState ? "" : " hidden")}>
          ...
          <button onClick={handleSubmit} className="w-2/12 mx-2 hover:shadow-lg flex flex-row justify-center items-center text-gray-900 dark:text-gray-50 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 py-1 px-4 focus:outline-none hover:bg-gray-50 dark:hover:bg-gray-800 rounded-full text-base">🔎</button>
        </div>
      </div>
    </header>
  );
